...
function TransactionRow({ transaction }: { transaction: any }) {
  ...
  return (
    <div className="flex items-center justify-between p-4 bg-[#1A1A1A]/60 border border-[#3F3F46] rounded-lg hover:bg-[#1A1A1A]/80 transition-colors">
      ...
      <Link
        href={`https://shannon-explorer.somnia.network/tx/${transaction.hash}`}
        target="_blank"
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                ...
                <div className="text-white text-xl font-bold">{nftData.totalRevenue} STT</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      <div className="bg-[#121212]/80 border border-[#3F3F46] rounded-xl p-6">
        ...
        <div className="text-2xl font-bold text-white">{nftData.userStakeAmount} STT</div>
      ...
      <div className="bg-[#121212]/80 border border-[#3F3F46] rounded-xl p-6">
        ...
        <div className="text-2xl font-bold text-white">{nftData.pendingRewards} STT</div>
